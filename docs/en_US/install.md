...
```bash
$ wget "https://github.com/rmqtt/rmqtt/releases/download/0.2.9/rmqtt-0.2.9-x86_64-unknown-linux-musl.zip"
```

2. Decompress the zip package you downloaded from [GitHub Release](https://github.com/rmqtt/rmqtt/releases).

```bash
$ unzip rmqtt-0.2.9-x86_64-unknown-linux-musl.zip -d /app/
```
