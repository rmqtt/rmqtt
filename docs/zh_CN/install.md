...
```bash
$ wget "https://github.com/rmqtt/rmqtt/releases/download/0.2.12/rmqtt-0.2.12-x86_64-unknown-linux-musl.zip"
```

2. 解压从[GitHub Release](https://github.com/rmqtt/rmqtt/releases) 下载的zip包。

```bash
$ unzip rmqtt-0.2.12-x86_64-unknown-linux-musl.zip -d /app/
```
