...
cargo publish --registry crates-io --all-features --manifest-path rmqtt-plugins/rmqtt-delayed/Cargo.toml
...
@REM cargo publish --registry crates-io --all-features --manifest-path rmqtt-conf/Cargo.toml
